...
struct CheckInRequest: Codable { let intensity: Int; let trigger: String; let copingAction: String; let note: String?; let resisted: Bool; let usedNicotine: Bool?; let occurredAt: Date }
struct CheckInResponse: Codable, Identifiable { let id: String; let intensity: Int; let trigger: String; let copingAction: String; let note: String?; let resisted: Bool; let usedNicotine: Bool?; let occurredAt: Date }
